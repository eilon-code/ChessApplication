...
import com.chessmaster.game.androidobjects.CameraHandler;
import com.chessmaster.game.androidobjects.PermissionManager;
import com.chessmaster.game.androidobjects.SQLiteDataBaseHandler;
import com.chessmaster.game.androidobjects.TextureViewActor;
...
public class AndroidLauncher extends AndroidApplication implements CameraLauncher {
	...
	TextureViewActor cameraTextureView;
...
// 		TextureView textureView = findViewById(R.id.textureView);
		...
		ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(500, 1000);
		textureView.setLayoutParams(params);
		cameraTextureView = new TextureViewActor(textureView);
