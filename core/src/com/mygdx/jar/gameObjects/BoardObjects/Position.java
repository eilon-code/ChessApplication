...
public class Position {
    ...
    public boolean detect_CheckmateIn_1_Moves(){
        Move[] moves = new Move[6];
        return detect_CheckmateIn_X_Moves(1, Is_white_turn, moves);
    }
    ...
    public static void Play_move(Move move) {
        setDangerCell(false);
        if (move.Type_of_piece.equals("King") && Chess_Board.The_Grid[move.Next_row][move.Next_column].Type.equals("Rook") &&
                move.Is_white == Chess_Board.The_Grid[move.Next_row][move.Next_column].Color_piece.equals("white")){
            move.setCastle();
        }
